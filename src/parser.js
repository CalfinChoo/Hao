...
const Tile = function(x, y, passable, spawn, checkpoint, death, name, sprite, size, endpoint){
  this.x = x;
  this.y = y;
...
var parser = function(array){
  var arr = [];
  var temp = [];
  var passable, spawn, checkpoint, death, name, sprite, size, endpoint;
  for (var y = 0; y < array.length; y++){
    for (var x = 0; x < array[y].length; x++){
      ...
      if (array[y][x].includes("S")){
        ...
        name = "sky";
        sprite = "";
        temp.push(new Tile(x*tileSize, y*tileSize, passable, spawn, checkpoint, death, name, sprite, size, endpoint));
      }
